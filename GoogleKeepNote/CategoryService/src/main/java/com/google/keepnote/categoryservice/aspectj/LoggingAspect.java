package com.google.keepnote.categoryservice.aspectj;
...
public class LoggingAspect {
	...
	@Before("execution(* com.google.keepnote.categoryservice.controller.CategoryController.*(..))")
	public void before() {
		logger.debug("registerUser method of UserController called");
	}
	
	@Pointcut("execution (* com.google.keepnote.categoryservice.controller.CategoryController.*(..))")
