package com.google.keepnote.categoryservice.controller;
...
import com.google.keepnote.categoryservice.service.CategoryService;
...
public class CategoryController {
	...
	public ResponseEntity<?> createCategory(@RequestBody Category category) {
		try {
			...
			return new ResponseEntity<String>("Category already exist.Try creating new category", HttpStatus.CONFLICT);
		}
	}
