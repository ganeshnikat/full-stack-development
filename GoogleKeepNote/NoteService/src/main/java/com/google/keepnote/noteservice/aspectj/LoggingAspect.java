package com.google.keepnote.noteservice.aspectj;
...
private static final Logger logger = LoggerFactory.getLogger(LoggingAspect.class);
	...
	@Before("execution(* com.google.keepnote.noteservice.controller.NoteController.*(..))")
	public void before() {
		logger.debug("NoteController method  called");
	}
	
	@Pointcut("execution (* com.google.keepnote.noteservice.controller.NoteController.*(..))")
