## GoogleKeepNote UserAuthenticationService Assignment

### Problem Statement

In this case study KeepNote - UserAuthenticationService, We will write main class for spring boot Application, model class, repository class, service class and interface, logging aspect.
