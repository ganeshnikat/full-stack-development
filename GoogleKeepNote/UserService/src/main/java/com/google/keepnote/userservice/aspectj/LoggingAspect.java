package com.google.keepnote.userservice.aspectj;
...
private static final Logger logger = LoggerFactory.getLogger(LoggingAspect.class);
	...
	@Before("execution(* com.google.keepnote.userservice.controller.UserController.*(..))")
	public void before() {
		logger.debug("registerUser method of UserController called");
	}
	
	@Pointcut("execution (* com.google.keepnote.userservice.controller.UserController.*(..))")
