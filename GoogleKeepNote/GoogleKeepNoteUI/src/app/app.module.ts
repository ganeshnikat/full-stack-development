...
const routes: Routes = [
  ...
  {path:'display-reminder', component: ReminderDisplayComponent,
    children:[
      {path:'view/reminderview', component: ReminderViewComponent},
      {path:'reminder/:reminderid/edit',component: EditReminderOpenerComponent, outlet: 'remEditOutlet'},
...
@NgModule({
  ...
  providers: [NotesService, AuthenticationService, RouterService,
    CanActivateRouteGuard, CategoriesService, ReminderService, DialogService],
  bootstrap: [AppComponent],
  entryComponents: [EditNoteViewComponent, EditCategoryViewComponent,EditReminderViewComponent, DialogComponent]
})
