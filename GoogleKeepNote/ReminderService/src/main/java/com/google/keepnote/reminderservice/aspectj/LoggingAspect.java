package com.google.keepnote.reminderservice.aspectj;
...
private static final Logger logger = LoggerFactory.getLogger(LoggingAspect.class);
	...
	@Before("execution(* com.google.keepnote.reminderservice.controller.ReminderController.*(..))")
	public void before() {
		logger.debug("registerUser method of UserController called");
	}
	
	@Pointcut("execution (* com.google.keepnote.reminderservice.controller.ReminderController.*(..))")
