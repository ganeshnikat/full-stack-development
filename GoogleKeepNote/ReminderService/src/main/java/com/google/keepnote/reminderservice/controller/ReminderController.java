package com.google.keepnote.reminderservice.controller;
...
import com.google.keepnote.reminderservice.service.ReminderService;
...
public class ReminderController {
	...
	public ResponseEntity<?> createReminder(@RequestBody Reminder reminder) {
		try {
			...
			return new ResponseEntity<String>("Reminder already exist.Try creating new reminder", HttpStatus.CONFLICT);
		}
	}
